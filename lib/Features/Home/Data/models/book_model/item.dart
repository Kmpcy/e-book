...
class Item extends Equatable {
	...
	factory Item.fromJson(Map<String, dynamic> json) => Item(
				...
				volumeInfo: json['volumeInfo'] == null
						? null
						: VolumeInfo.fromJson(Map<String, dynamic>.from(json['volumeInfo'])),
				saleInfo: json['saleInfo'] == null
						? null
						: SaleInfo.fromJson(Map<String, dynamic>.from(json['saleInfo'])),
				accessInfo: json['accessInfo'] == null
						? null
						: AccessInfo.fromJson(Map<String, dynamic>.from(json['accessInfo'])),
				searchInfo: json['searchInfo'] == null
						? null
						: SearchInfo.fromJson(Map<String, dynamic>.from(json['searchInfo'])),
			);
