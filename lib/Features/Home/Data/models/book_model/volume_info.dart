...
class VolumeInfo extends Equatable {
	...
	factory VolumeInfo.fromJson(Map<String, dynamic> json) => VolumeInfo(
				...
				industryIdentifiers: (json['industryIdentifiers'] as List<dynamic>?)
						?.map((e) => IndustryIdentifier.fromJson(Map<String, dynamic>.from(e)))
						.toList(),
				readingModes: json['readingModes'] == null
						? null
						: ReadingModes.fromJson(Map<String, dynamic>.from(json['readingModes'])),
				...
				panelizationSummary: json['panelizationSummary'] == null
						? null
						: PanelizationSummary.fromJson(Map<String, dynamic>.from(json['panelizationSummary'])),
	...
	Map<String, dynamic> toJson() => {
				...
				if (industryIdentifiers != null) 'industryIdentifiers': industryIdentifiers?.map((e) => e.toJson()).toList(),
